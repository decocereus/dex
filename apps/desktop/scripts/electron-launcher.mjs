// This file mostly exists because we want dev mode to say "dex (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.amartyasing.dex.dev" : "com.amartyasing.dex";
