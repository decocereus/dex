...
import { parseScopedThreadKey, scopedThreadKey } from "@dex/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@dex/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "dex:terminal-state:v1";
