...
import { CodexModelSelection } from "@dex/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@dex/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `dex-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
