import type { GitStatusRemoteResult, GitStatusResult } from "@dex/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:Dex/Dex.git")).toBe("github.com/dex/dex");
    expect(normalizeGitRemoteUrl("https://github.com/Dex/Dex.git")).toBe("github.com/dex/dex");
    expect(normalizeGitRemoteUrl("ssh://git@github.com/Dex/Dex")).toBe("github.com/dex/dex");
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:Dex/platform/Dex.git")).toBe(
      "gitlab.com/dex/platform/dex",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/Dex/platform/Dex.git")).toBe(
      "gitlab.com/dex/platform/dex",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:Dex/Dex.git")).toBe(
      "Dex/Dex",
    );
    expect(parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/Dex/Dex.git")).toBe(
      "Dex/Dex",
    );
  });
});
